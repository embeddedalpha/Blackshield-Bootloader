...
class BootloaderGUI(ctk.CTkFrame):
    ...
    def _build_serial_card(self):
        ...
        self.open_btn = ctk.CTkButton(body, text="Open Port", width=110, height=32, command=self.open_port, fg_color=ACCENT, hover_color=ACCENT_HOVER, text_color=BUTTON_TEXT_DARK, text_color_disabled=BUTTON_TEXT_DARK)
    ...
    def _build_control_card(self):
        ...
        self.connect_btn = ctk.CTkButton(button_row, text="Connect", width=120, height=32, command=self.connect_device, state="disabled", fg_color=SUCCESS, hover_color="#15803D", text_color=BUTTON_TEXT_DARK, text_color_disabled=BUTTON_TEXT_DARK)
        ...
        self.browse_btn = ctk.CTkButton(ops, text="Browse Firmware", width=150, height=34, command=self.browse_file, fg_color=ACCENT, hover_color=ACCENT_HOVER, text_color=BUTTON_TEXT_DARK, text_color_disabled=BUTTON_TEXT_DARK)
        ...
        self.erase_btn = ctk.CTkButton(ops, text="Erase Firmware", width=145, height=34, command=self.erase_firmware, state="disabled", fg_color=WARNING, hover_color="#B45309", text_color=BUTTON_TEXT_DARK, text_color_disabled=BUTTON_TEXT_DARK)
        self.reboot_btn = ctk.CTkButton(ops, text="Reboot", width=145, height=34, command=self.reboot_mcu, state="disabled", fg_color=DANGER, hover_color="#B91C1C", text_color=BUTTON_TEXT_DARK, text_color_disabled=BUTTON_TEXT_DARK)
